Extraction :
    This project extracts useful information from different documents using an LLM.


Confidence :
    This project calculates the confidence of the extracted information using an LLM.
